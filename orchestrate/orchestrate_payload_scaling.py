    ...
    with closing(UM24C(UM24C_PORT)) as um24c:
        ...
        with ENERGY_RESULT_FILE.open("w", encoding="utf-8") as output:
            ...
            for payload_size in PAYLOAD_SIZES:
                ...
                run_energy_case(um24c, output, "PSK", "Encrypt", payload_size)
                run_energy_case(um24c, output, "PSK", "Decrypt", payload_size)
                run_energy_case(um24c, output, "RSA", "Encrypt", payload_size)
                run_energy_case(um24c, output, "RSA", "Decrypt", payload_size)
                run_energy_case(um24c, output, "CPABE", "Encrypt", payload_size)
                run_energy_case(um24c, output, "CPABE", "Decrypt", payload_size)
...
def orchestrate_timing():
    ...
    with TIMING_RESULT_FILE.open("w", encoding="utf-8") as destination_file:
        ...
        for payload_size in PAYLOAD_SIZES:
            ...
            run_timing_case(destination_file, "PSK", "Encrypt", payload_size)
            run_timing_case(destination_file, "PSK", "Decrypt", payload_size)
            run_timing_case(destination_file, "RSA", "Encrypt", payload_size)
            run_timing_case(destination_file, "RSA", "Decrypt", payload_size)
            run_timing_case(destination_file, "CPABE", "Encrypt", payload_size)
            run_timing_case(destination_file, "CPABE", "Decrypt", payload_size)
