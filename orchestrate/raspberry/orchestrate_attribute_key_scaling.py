...
RESULT_DIRECTORY = PROJECT_DIRECTORY / "results" / "attribute-key-scaling"
...
def load_environment_variables():
    ...
    CACHE_DIRECTORY = PROJECT_DIRECTORY / os.environ["CACHE_DIRECTORY"]
...
def build_binaries():
    ...
    subprocess.run(
        ["go", "test", "-c", "-o", BENCHMARK_BINARY, "./micro/attribute_key_scaling"],
...
def generate_report():
    ...
    subprocess.run(
        [sys.executable, "-m", "report.analysis.attribute_key_scaling_report"],
